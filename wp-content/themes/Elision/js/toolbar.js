...
$j(document).ready(function() {
	...
	$j('ul#tootlbar_header_top li').click(function(){
    	...
    	$j.post(root+'updatesession.php', {elision_header_top : $j(this).attr("data-value")}, function(data){
				location.reload();
			});
		}
	});
	...
	$j('ul#tootlbar_smooth_scroll li').click(function(){
		if($j(this).attr("data-value") != ""){
    	$j.post(root+'updatesession.php', {elision_smooth : $j(this).attr("data-value")}, function(data){
				location.reload();
			});
		}
	});
