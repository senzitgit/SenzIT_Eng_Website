...
<?php if( is_page('smarter-solutions') || is_page('meet-the-team')  ) { ?> 

<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/my_style/styles.css" type="text/css" />

<!--<script src="//code.jquery.com/jquery-1.11.0.min.js"></script>

<script src="<?php bloginfo('template_directory'); ?>/my_style/jqueryfn.js" type="text/javascript"></script>-->
