...
vc_map( array(
  ...
  "params" => array(
    array(
      ...
      "param_name" => "content",
      "value" => "<p>".__("I am text block. Click edit button to change this text.", "js_composer")."</p>"
    ),
    $add_css_animation,
    array(
      "type" => "textfield",
...
vc_map( array(
  ...
  "custom_markup" => '
  <div class="wpb_parallax_holder wpb_holder clearfix vc_container_for_children">
  %content%
  </div>
  <div class="tab_controls">
  <button class="add_tab" title="'.__("Add parallax section", "js_composer").'">'.__("Add parallax section", "js_composer").'</button>
  </div>
  ',
  'default_content' => '
  [vc_parallax_section title="'.__('Section 1', "js_composer").'"][/vc_parallax_section]
  [vc_parallax_section title="'.__('Section 2', "js_composer").'"][/vc_parallax_section]
  ',
  'js_view' => 'VcParallaxView'
) );
vc_map( array(
  "name" => __("Parallax Section", "js_composer"),
  ...
  "params" => array(
    array(
      ...
      "heading" => __("Title", "js_composer"),
      "param_name" => "title",
      "description" => __("Parallax section title.", "js_composer")
    ),
	array(
      "type" => "attach_image",
      "heading" => __("Background Image", "js_composer"),
      "param_name" => "background_image",
      "description" => __("Prallax section background image.", "js_composer")
    ),
	array(
      "type" => "textfield",
      "heading" => __("Section height", "js_composer"),
      "param_name" => "height",
      "description" => __("Section height.", "js_composer")
    ),
	array(
      "type" => "dropdown",
      "heading" => __("Content position", "js_composer"),
      "param_name" => "position",
	   "value" => array(__("center", "js_composer"),__("left", "js_composer"),__("right"), "js_composer"),
      "description" => __("Content position.", "js_composer")
    )
  ),
  'js_view' => 'VcParallaxTabView'
) );
...
vc_map( array(
  "name" => 'WP ' . __("Recent Comments", "js_composer"),
...
vc_map( array(
  "name" => 'WP ' . __("Calendar", "js_composer"),
  "base" => "vc_wp_calendar",
  "icon" => "icon-wpb-wp",
  "category" => __("WordPress Widgets", "js_composer"),
  "class" => "wpb_vc_wp_widget",
...
endforeach;
vc_map( array(
  "name" => 'WP ' . __("Tag Cloud", "js_composer"),
  "base" => "vc_wp_tagcloud",
  "icon" => "icon-wpb-wp",
  "category" => __("WordPress Widgets", "js_composer"),
  "class" => "wpb_vc_wp_widget",
...
vc_map( array(
"name" => 'WP ' . __("Custom Menu", "js_composer"),
...
vc_map( array(
  "name" => 'WP ' . __("Recent Posts", "js_composer"),
  "base" => "vc_wp_posts",
  "icon" => "icon-wpb-wp",
  "category" => __("WordPress Widgets", "js_composer"),
  "class" => "wpb_vc_wp_widget",
  "params" => array(
    ...
    array(
      ...
      "value" => array(__("Display post date?", "js_composer") => true )
    ),
    array(
      "type" => "textfield",
      "heading" => __("Extra class name", "js_composer"),
...
vc_map( array(
  "name" => 'WP ' . __("Categories", "js_composer"),
...
vc_map( array(
  "name" => 'WP ' . __("Archives", "js_composer"),
  "base" => "vc_wp_archives",
  "icon" => "icon-wpb-wp",
  "category" => __("WordPress Widgets", "js_composer"),
  "class" => "wpb_vc_wp_widget",
