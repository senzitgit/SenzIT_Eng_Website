...
class WonderPlugin_Tabs_View {
	...
	function print_item()
	{
		...
		<div class="updated"><p style="text-align:center;">  <?php _e( 'To directly edit the tab content in your post or page, you can use the following shortcode:', 'wonderplugin_tabs' ); ?></p></div>
