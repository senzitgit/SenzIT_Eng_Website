...
define('WONDERPLUGIN_TABS_VERSION', '2.6');
...
define('WONDERPLUGIN_TABS_PLUGIN_VERSION', '2.6');
...
class WonderPlugin_Tabs_Plugin {
	...
	{		
		...
		wp_register_script('wonderplugin-tabs-creator-script', WONDERPLUGIN_TABS_URL . 'app/wonderplugin-tabs-creator.js', array('jquery'), WONDERPLUGIN_TABS_VERSION, false);	
