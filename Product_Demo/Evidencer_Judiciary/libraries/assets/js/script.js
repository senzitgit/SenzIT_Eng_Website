$(document).ready(function(){
	...
	webcam.set_api_url('SaveAttachmentService.jsp');	// The upload script
	...
	webcam.set_hook('onError',function(e){
		...
		var moviescreen = document.getElementById('screen');
		moviescreen.innerHTML= '<center><br><br><br><br><div style="font-size:30px;color:#c6aa5d" class="fa fa-warning"></div><br><P style="color:#c6aa5d">No Webcam Found!!!<br> Connect your webcam and try again..</P><br><br><br><center>';    
