...
(function (window, document, $) {
	...
	F.helpers.overlay = {
		...
		liveVid1.innerHTML ='<img src="images/poster0.jpg" height="420px;">';
		
		
		var liveVid2 = document.getElementById("liveVid2");
		liveVid2.innerHTML ='<img src="images/poster.jpg" height="220px;">';
},

		afterClose: function (opts) {
		
		
		            var feed1 = localStorage.getItem("vidFeed2");
	   				var feed2 = localStorage.getItem("vidFeed1");
		
	            	var liveVid1 = document.getElementById("liveVid1");
	   				liveVid1.innerHTML ='<embed wmode="opaque"   type="application/x-vlc-plugin" pluginspage="http://www.videolan.org" version="VideoLAN.VLCPlugin.2"  id="vlc" loop="yes" autoplay="yes" target="'+ feed1 +'" height="420px" width="100%">';
	   				
	   				
	   				var liveVid2 = document.getElementById("liveVid2");
	   				liveVid2.innerHTML ='<embed wmode="opaque"   type="application/x-vlc-plugin" pluginspage="http://www.videolan.org" version="VideoLAN.VLCPlugin.2"  id="vlc" loop="yes" autoplay="yes" target="'+ feed2 +'" height="220px" width="100%">';
