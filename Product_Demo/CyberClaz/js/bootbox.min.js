...
! function(a, b) {
    ...
    var n = {
            ...
            inputs: {
                text: "<input class='bootbox-input bootbox-input-text form-control' autocomplete=off type=text data-required='true' required />",
    ...
    p.alert = function() {
        ...
        if (g(j, function(a, b) {
                k += "<button data-bb-handler='" + a + "' type='submit' class='btn " + b.className + "'>" + b.label + "</button>", l[a] = b.callback
    ...
    var q = {
        ...
        th: {
            OK: "Ã Â¸â€¢Ã Â¸ï¿½Ã Â¸Â¥Ã Â¸â€¡",
            CANCEL: "Ã Â¸Â¢Ã Â¸ï¿½Ã Â¹â‚¬Ã Â¸Â¥Ã Â¸Â´Ã Â¸ï¿½",
