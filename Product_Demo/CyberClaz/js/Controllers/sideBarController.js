...
if(userRole=='Student'){
	...
	sideBar.innerHTML = sideBar.innerHTML +'<li class="dropdown-submenu"> <a href="student_dashboard.html"><i class="fa fa-dashboard"></i> Dashboard</a> </li> ';
	...
	if(liveSessionFlagForSideBar=="1"){
		...
		sideBar.innerHTML = sideBar.innerHTML +'<li class="dropdown-submenu" id="liveClassSideMenu"> <a href="live_class.html"><i class="fa fa-users"></i> Live Class</a> </li> ';
...
if(userRole=='Teacher'){
	...
	sideBar.innerHTML = sideBar.innerHTML +'<li class="dropdown-submenu"> <a href="teacher_dashboard.html"><i class="fa fa-dashboard"></i> Dashboard</a> </li> ';
...
var sideBar = document.getElementById("sideBar");
sideBar.innerHTML = sideBar.innerHTML +'<li class="dropdown-submenu"> <a href="search_class.html"><i class="fa fa-search"></i> Claz Player</a> </li> ';


var sideBar = document.getElementById("sideBar");
sideBar.innerHTML = sideBar.innerHTML +'<li class="dropdown-submenu"> <a href="media_library.html"><i class="fa fa-files-o"></i> Library</a> </li> ';

var sideBar = document.getElementById("sideBar");
sideBar.innerHTML = sideBar.innerHTML +'<li class="dropdown-submenu"> <a href="profile.html"><i class="fa fa-user"></i> Profile</a> </li> ';
...
if(userRole=='Teacher'){
		...
		sideBar.innerHTML = sideBar.innerHTML +'<li class="dropdown-submenu"> <a href="claz_element.html" "><i class="fa fa-lightbulb-o"></i> Claz Behavior</a> </li> ';
