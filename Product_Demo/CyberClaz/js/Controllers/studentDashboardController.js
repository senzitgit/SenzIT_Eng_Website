...
function attendClass() {
	    ...
	    if (is_mobile == true) {
	    	window.location="live_class_mobile.html";
	    }else {
	    	
	    	window.location="live_class.html";
	...
	$(window).on('beforeunload', function(){
	  ...
	  $('#calendar').fullCalendar({
		    ...
		    dayClick: function(date, jsEvent, view) {
		       ...
		       var schedule = statusResult.studentTimeTable;
		        ...
		        if(clickDate == "Mon"){
		        	...
		        	//  alert(JSON.stringify(curDay));
		        	  ...
		        	  for (var i = 0; i < curDay.length; i++) {
		    				...
		    				div.innerHTML = div.innerHTML + '<span class="badge bg-success">'+ timez +'</span><br><br><div style="width:300px;">Teacher Name : '+ counter.teacherName +' </div><br><div style="width:300px;">Subject : '+ counter.subject +' </div><br>';
